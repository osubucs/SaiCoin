...
SaiCoin Core tree 0.12.x release notes can be found here:
- [v0.12.0](release-notes/dash/release-notes-0.12.0.md)

SaiCoin Core tree 0.12.x is a fork of Bitcoin Core tree 0.10.2
...
SaiCoin was previously known as Darkcoin.
...
SaiCoin Core tree 0.11.x was a fork of Bitcoin Core tree 0.9, Darkcoin was rebranded
to SaiCoin.
