    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SaiCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About SaiCoin Core"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SaiCoin Core is shutting down...") + "<br /><br />" +
