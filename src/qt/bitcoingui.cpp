    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SaiCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SaiCoin address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SaiCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SaiCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SaiCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SaiCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SaiCoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the SaiCoin Core help message to get a list with possible SaiCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SaiCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("SaiCoin Core"); // default title
