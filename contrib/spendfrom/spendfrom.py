...
#
# Assumes it will talk to a dashd or SaiCoin-Qt running
# on localhost.
#
# Depends on jsonrpc
#
...
def determine_db_dir():
    ...
    if platform.system() == "Darwin":
        return os.path.expanduser("~/Library/Application Support/SaiCoin/")
    elif platform.system() == "Windows":
        return os.path.join(os.environ['APPDATA'], "SaiCoin")
