...
#   c) node1 mines 101 blocks, so now nodes 0 and 1 have 500 DPC, node2 has none. 
#   d) node0 sends 21 DPC to node2, in two transactions (11 DPC, then 10 DPC).
...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # node0 should end up with 1000 DPC in block rewards plus fees, but
