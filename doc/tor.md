...
It is possible to run SaiCoin as a Tor hidden service, and connect to such services.
...
The first step is running SaiCoin behind a Tor proxy. This will already make all
