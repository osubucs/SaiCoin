...
*Setup instructions for a gitian build of SaiCoin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the SaiCoin
...
- [Building SaiCoin](#building-dash)
...
To build SaiCoin (for Linux, OSX and Windows) just follow the steps under 'perform
