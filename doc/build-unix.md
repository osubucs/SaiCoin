UNIX BUILD NOTES
====================
Some notes on how to build SaiCoin in Unix. 
...
memory available when compiling SaiCoin Core. With 512MB of memory or less
...
If you want to build SaiCoin-Qt, make sure that the required packages for Qt development
...
# Configure SaiCoin Core to use our own-built instance of BDB
cd $DASH_ROOT
...
Security
--------
To help make your SaiCoin installation more secure by making certain attacks impossible to
